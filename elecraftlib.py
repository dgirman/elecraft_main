...
class LibK3:
    ...
    def getDisplay(self):
        ...
        for i in range(8):
            ...
            if DEBUG: print('c raw, c value, c, mask, mask2, point, char ', c_raw, c_char, c, mask, mask2, points, chars)
        for i in range(8):
    ...
    def getEqSettings(self, tx):
        ...
        """
        settings_dB = []
        eqCmd = 'MN009;' if tx else 'MN008;'  # Open EQ for tx/rx respectively.
